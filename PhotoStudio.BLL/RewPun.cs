...
namespace PhotoStudio.BLL
{
	...
	{
		private readonly PhotoStudio.DAL.RewPun dal=new PhotoStudio.DAL.RewPun();
		public RewPun()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<PhotoStudio.Model.RewPun> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<PhotoStudio.Model.RewPun> DataTableToList(DataTable dt)
		{
			List<PhotoStudio.Model.RewPun> modelList = new List<PhotoStudio.Model.RewPun>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				PhotoStudio.Model.RewPun model;
