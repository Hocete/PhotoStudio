...
namespace PhotoStudio.Common
{
    public partial class Validator
    {
        ...
        /// </remarks>
        public  bool IsDateTime(string strln)
        {
        ...
        /// <returns></returns>
        public  bool IsMobile(string strln)
        {
            if (strln != null)
            {
        ...
        /// <param name="strln"></param>
        /// <returns></returns>
        public  bool IsIDCard(string strln)
        {
        ...
        /// <returns></returns>
        public  bool IsIDCard18(string strln)
        {
        ...
        /// <param name="strln">输入的字符</param>
        /// <returns></returns>
        public  bool IsIDCard15(string strln)
        {
            if (strln != null)
            {
                long n = 0;
        ...
        /// <returns>返回一个bool类型的值</returns>
        public  bool IsPhone(string strln)
        {
            if (strln != null)
            {
        ...
        /// <param name="strln">输入的字符</param>
        /// <returns></returns>
        public  bool IsEmail(string strln)
        {
            if (strln != null)
            {
        ...
        /// <param name="strln">输入的字符</param>
        /// <returns></returns>
        public  bool IsFax(string strln)
        {
            if (strln != null)
            {
        ...
        /// <param name="strln">输入的字符</param>
        /// <returns></returns>
        public  bool IsOnllyChinese(string strln)
        {
            if (strln != null)
            {
